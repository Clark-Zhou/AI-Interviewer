...
// 前端请求层：请求后端生成结构化面试问题。
export async function generateInterviewQuestions({ jobTitle = '', jobInfo, resume }) {
...
export async function evaluateInterview({ jobTitle = '', jobInfo, resume, questionAnswers }) {
